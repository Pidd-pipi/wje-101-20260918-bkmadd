...
CREATE INDEX IF NOT EXISTS idx_tasting_notes_status ON tasting_notes(status);
...
INSERT INTO tasting_notes (user_id, coffee_name, origin, roast_level, flavor_tags, aroma_score, acidity_score, body_score, overall_score, brew_method, brew_recipe_id, notes_text, image_url, status) VALUES
  (2, '埃塞俄比亚耶加雪菲', '埃塞俄比亚', 'light', '["柑橘","茉莉"]', 8.5, 8.0, 7.0, 8.3, '手冲', 1, '花香明显，柑橘酸质明亮，回甘持久。', 'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=600', 'published'),
  (3, '哥伦比亚慧兰', '哥伦比亚', 'medium', '["坚果","焦糖"]', 7.5, 6.8, 7.8, 7.6, '法压', 2, '甜感平衡，坚果香气浓郁。', 'https://images.unsplash.com/photo-1447933601403-0c6688de566e?w=600', 'published'),
  (2, '哥斯达黎加蜜处理', '哥斯达黎加', 'medium', '["莓果","红糖"]', 8.0, 7.2, 8.0, 7.9, '手冲', 0, '莓果酸甜与红糖甜感交织。', 'https://images.unsplash.com/photo-1517701604599-bb29b565090c?w=600', 'published'),
  (2, '', '', '', '[]', 0, 0, 0, 0, '', 0, '周末新到一支肯尼亚，待杯测记录……', NULL, 'draft');
